...
def split_filtered_csv(input_file, output_file, num_entries_per_type):
    with open(input_file, 'r', encoding='utf-8') as csv_file:
        ...
        for row in reader:
            ...
            elif gender == 'women' and master_category == 'accessories' and len(female_accessories_entries) < num_entries_per_type:
                female_accessories_entries.append(row)
        ...
        female_entries = female_tops_entries + female_skirts_entries + female_shoes_entries + female_accessories_entries
        ...
        print("Number of female accessories entries:", len(female_accessories_entries))
...
if __name__ == "__main__":
    ...
    output_csv_file = "dataset/user_history_data/gwen_2.csv"  # Replace with the desired output CSV file name
